...
- 当前稳定补丁线：2.6.x
- 2.6.2 发布内容：GameData pair metadata 幂等激活；无变化 Auto-Sync 周期不再误触发缓存清理，真实 generation 切换与 metadata 重建语义保持不变。
...
| 版本 | 日期 | 亮点 |
|------|------|------|
| 2.6.2 | 2026-08-12 | GameData pair metadata 幂等激活；无变化周期不再误清缓存 |
